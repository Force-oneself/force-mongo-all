...
public class MongoTemplate implements MongoOperations, ApplicationContextAware, IndexOperationsProvider {
    ...
    private @Nullable
    MongoPersistentEntityIndexCreator indexCreator;
    ...
    public <T> List<T> find(Query query, Class<T> entityClass) {
        // 默认还是走这个使用String集合名称的方法，说明这个方法执行效率要高
    ...
    protected UpdateResult doUpdate(final String collectionName, final Query query, final UpdateDefinition update,
        ...
        return execute(collectionName, collection -> {
            ...
            Document updateObj = update instanceof MappedUpdate
    ...
    public <O> AggregationResults<O> aggregate(Aggregation aggregation, String collectionName, Class<O> outputType) {
        // TODO 为什么不传AggregationOperationContext？
     ...
     * @param fields         the document that specifies the fields to be returned.
     * @param entityClass    the parameterized type of the returned list.
     * @param preparer       允许自定义在迭代结果集时使用的 {@link DBCursor}，（应用限制、跳过等）.
     * @return the {@link List} of converted objects.
     */
    protected <T> List<T> doFind(String collectionName, Document query, Document fields, Class<T> entityClass,
        ...
        try {
            ...
            try {
                ...
                while (cursor.hasNext()) {
                    ...
                    // 回调, objectCallback.doWith(object)元素会返回null，集合需要过滤掉null
